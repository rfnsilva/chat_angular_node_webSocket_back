...
exports.createTables1596606726826 = void 0;

class createTables1596606726826 {
  async up(queryRunner) {
    ...
    await queryRunner.query(`CREATE TABLE "mensagem" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
          "autor" character varying(100) NOT NULL,,
          "mensagem" character varying(500) NOT NULL,
          "userId" uuid,
          CONSTRAINT "REL_0b343f6b8ca70f5ee3d9fqb956" UNIQUE ("userId"),
          "grupoId" uuid,
          CONSTRAINT "REL_0b349f6b8ca70f5eed39ffb956" UNIQUE ("grupoId"),
          "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
          "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
          CONSTRAINT "PK_23451caefbb11b5a2fa29s96828" PRIMARY KEY ("id"))`);
    await queryRunner.query(`CREATE TABLE "grupo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(),
          "nome" character varying(100) NOT NULL,
          "createdAt" TIMESTAMP NOT NULL DEFAULT now(),
          "updatedAt" TIMESTAMP NOT NULL DEFAULT now(),
    ...
    await queryRunner.query(`ALTER TABLE "mensagem" ADD CONSTRAINT "FK_2652443e9129c83cde72dg281db" FOREIGN KEY ("grupoId") REFERENCES "grupo"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
...
exports.createTables1596606726826 = createTables1596606726826;