...
let User = (_dec = (0, _typeorm.Entity)('user'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("varchar"), _dec5 = (0, _typeorm.Column)("varchar"), _dec6 = (0, _typeorm.OneToMany)(type => _Mensagem.Mensagem, mensagem => mensagem.user), _dec7 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
}), _dec8 = (0, _typeorm.CreateDateColumn)({
  type: "timestamp"
}), _dec(_class = (_class2 = (_temp = class User {
  constructor() {
    ...
    _initializerDefineProperty(this, "mensagens", _descriptor5, this);
  ...
  writable: true,
  initializer: null
}), _descriptor5 = _applyDecoratedDescriptor(_class2.prototype, "mensagens", [_dec6], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
